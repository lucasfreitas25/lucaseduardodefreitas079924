...
import { Dog, Plus, Search, Trash } from 'lucide-react';
                    ...
                    <div className="flex gap-2 absolute top-2 right-2">
                        <button
                            onClick={(e) => {
                                e.preventDefault();
                                e.stopPropagation();
                                navigate(`/pets/${pet.id}/edit`, { state: { from: `/pets?${searchParams.toString()}` } });
                            }}
    ...
    return (
        <section className="space-y-6">
            <PageHeader
                ...
                subtitle="Gerencie todos os pets cadastrados"
                icon={Dog}
                action={{
                    label: "Novo Pet",
                    icon: Plus,
                ...
                <>
                    {data?.items && data.items.length > 0 ? (
                        ...
                        <EmptyState
                            ...
                            description="Adicione um novo pet para começar!"
                            icon={Search}
                        />
                    )}
                    {data && (
